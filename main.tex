...
文基于量子态扩散的变分量子模拟算法,研究马尔可夫开放量子系统中的动力学
量子相变\citep{fan2025classicalvsquantumdynamics}. 
该算法通过将Lindblad主方程重构为纯态轨迹的系综演化,显著降低了
对量子资源的需求,从而高效模拟耗散量子动力学.以一维横场伊辛模型为研究
对象,模拟了局域与全局Lindblad耗散下的量子淬火动力学.结果表明,量子态扩
散-变分量子模拟算法能够准确捕捉Loschmidt速率函数中的非解析奇点,并揭示了其
随耗散强度与系统尺寸的变化规律:强局域耗散会渐进抑制动力学量子相变现象,而强全局耗散
因集体环境效应仍可维持相变的发生.通过将本方法的结果与精确Lindblad动力学解进行
基准对比,充分验证了该方法的准确性及良好的可扩展性.
