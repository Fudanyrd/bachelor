...
snowballing search, 31 in total.
...
\citep{codeflaws, condefects, defects4ds, fixeval}. The distribution
of dataset sources is shown in Figure~\ref{fig:data} and Table~\ref{tab:data}.

\begin{figure}[ht]
	\centering
	\caption{Source of Collected Datasets. \\
...
patches, reproducing bugs or manual patch review. After this pre-processing
