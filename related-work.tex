...
% LLM \citep{llmsurvey} based solutions to Automated Program Repairs (APR).
...
重点关注基于大型语言模型（LLM）\citep{llmsurvey}
...
% Retrieval Augmentation \citep{ragsurvey}, 
...
\paragraph{RQ3:} 研究人员如何验证代码LLMs生成的补丁的正确性？
...
% \subsection{RQ2: LLM Enhancement Techniques}
\subsection{RQ2: }
