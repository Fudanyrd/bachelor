...
\paragraph{滚雪球式搜索} 为了识别任何可能相关的主要研究，我们进行了滚雪球式搜索。
...
% Retrieval Augmentation, Prompt Engineering, as well as Agentic 
% Corportation, which are designed to enhance the performance of
% LLMs on various NLP tasks.

\paragraph{RQ2:} 目前有哪些技术被应用于提升大语言模型\footnote{以及多智能体系统}
在程序修复方面的性能？\textit{RQ2}探讨了不同优化技术在LLM自动程序修复背景下
的有效性。这包括对检索增强、提示工程、和多智能体协作等
用于增强大语言模型表现技术的总结。
