...
\paragraph{How are APR datasets collected and pre-processed?}
We first investigate the methods used to obtain the dataset.
Following the definitions of Hou et al. \citep{llm4se2},
...
including code repositories, CVE lists, etc.
